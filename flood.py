...
def convert():
    InNum = input(str("NUMARANI GİR (+90) VEYA (+1)\n  ÖRNEK: 9123356688   "))
    print("kaç adet gönderilsin? ", end="")
    Times = int(input())
    ...
    if InNum[0] == "8":
        ...
        print("Bir şeyler yanlış gitti. Numaradan önek ve diğer karakterleri kaldırmayı deneyin.")
        quit()
